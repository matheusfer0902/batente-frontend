...
Next.js 16 (App Router) · TypeScript strict · Tailwind v4 · Radix/Shadcn · Redux Toolkit + RTK Query · i18next · next-themes · RHF + Zod
...
| **L** Liskov | Contratos substituíveis (mock ↔ API real) |
...
- Modificar arquitetura sem atualizar `docs/`

## Novo módulo de feature

Replicar molde `resource`: types → schema → *Api → *Service → use* → components → pages → locales.
